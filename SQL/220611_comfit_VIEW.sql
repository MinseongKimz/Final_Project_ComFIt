...
GROUP BY PD_NUM, PD_REGIT_DATE, PD_TITLE, DEAL_TYPE, U_ID, DEAL_STATUS, BUYER_CODE, SELLER_CODE, SELL_OK, BUY_OK;
WHERE PD_NUM = '1';
...
THEN 'y'
ELSE 'n'
END AS SELL_COMP_DATE
, CASE
WHEN DCB.BUY_COMP_DATE IS NOT NULL 
THEN 'y'
ELSE 'n'
END AS BUY_COMP_DATE
,PC.CATEGORY_NAME CATEGORY_NAME, DP.PD_NAME PD_NAME, PM.PD_MAKER_ID PD_MAKER_ID, DP.PD_HOPEPRICE PD_HOPEPRICE, DP.PD_HOPE_PLACE PD_HOPE_PLACE, DP.PD_HOPE_SDATE PD_HOPE_SDATE, DP.PD_HOPE_STIME PD_HOPE_STIME
,SL.U_ID u_id, SL.SUGGEST_PRICE SUGGEST_PRICE, SL.SUGGEST_TIME SUGGEST_TIME, CONCAT(SL.SUGGEST_PLACE, SL.PLACE_DETAIL) SUGGEST_PLACE
,DCB.BUY_COMP_DATE 구매확정일시,DCS.SELL_COMP_DATE 판매확정일시
,SL.U_ID s_U_ID, SL.SUGGEST_TIME SUGGEST_TIME, SL.SUGGEST_PRICE SUGGEST_PRICE
, CASE
WHEN S.SELECTED_ID IS NOT NULL
THEN '낙찰'
ELSE '유찰'
