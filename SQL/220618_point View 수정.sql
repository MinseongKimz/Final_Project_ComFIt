...
SELECT *
FROM USER_OUTMONEY_VIEW;

-- 뷰 수정(OUTMONEY가 다안빠져나감)
SELECT U_ID, SUM(IN_MONEY) AS IN_MONEY_TOT
FROM
(
SELECT BUYER_ID AS U_ID, BISG_PRICE AS IN_MONEY
...
INSERT INTO DELI_COMPLETE_BUY(DELI_COMP_BUY_ID, REVIEW, BS_ID)   VALUES(CONCAT('dcbuy_', DELI_COMPLETE_SEQ.NEXTVAL), 'zz', 'bs_1');

DELI_COMPLETE_SEQ.NEXTVAL;
