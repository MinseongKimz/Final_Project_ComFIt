...
<div class="container">
	<div class="row">
	<div style="margin-bottom: 20px;"><h1><b>관리자모드_상품상세</b></h1></div> <!-- 왜 서체가? 배민서체지? 커스텀 css해놔서 그럼 -->
		<table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd; width: 700px">
			<thead><!-- 제목 -->
				...
				<tr>
				    ...
				    <td><form action=""><label><input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" checked disabled="disabled"><b>블라인드</b></label></form></td>		    
				</tr>		
				<tr>
