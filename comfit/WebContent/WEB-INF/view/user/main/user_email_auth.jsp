...
<div style="margin-left: 30%; margin-right: 30%; text-align: center; margin-top: 5%;">
   <span style="font-size: 25pt; font-weight: bold;" >${nickname} 님 안녕하세요</span>
   <hr />
      <span style="font-weight:bold; color:blue;">이메일 인증</span>을 한 이후 
      서비스 이용이 가능합니다. <br>
      <span style="font-weight:bold; color:blue;">${email }</span>의 메일함을 확인해주세요.
   <hr />
   <br />
</div>   
