...
<div class="header">
		...
		<div class="shadow p-3 mb-5 bg-body rounded">
			...
			<tr>
				...
				<th>
					...
					<span style="color: green; font-size: 10pt;">LV 2</span><br>
	 ...
	 <div class="content" >
	 <h3 class="inout_point">내 입출금내역</h3> <p class="neyuk">최근 입/출금</p>
		...
		<div class="content" >
		<h3 class="inout_point">내 판매</h3> <p class="neyuk">최근 판매내역</p>
		<table class="table table-bordered" style="width: 1000px;">
		    <thead>
		        <tr>
		            <th>낙찰일/채택일</th>
		...
		<div class="content" >
		<h3 class="inout_point">내 구매</h3> <p class="neyuk">최근 구매내역</p>
		<table class="table table-bordered" style="width: 1000px;">
		    <thead>
		        <tr>
		            <th>낙찰일/채택일</th>
