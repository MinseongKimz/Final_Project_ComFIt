...
<script type="text/javascript" src="<%=cp%>/js/jquery.timepicker.min.js"></script>
	...
	$(document).ready(function()
	{
		...
		$("#edate").datepicker(
		{
			...
			, changeYear: true
			, maxDate:+5
			,onClose: function( $("#edate").datepicker(minDate:0)) 
			{    
				$("#time1").timepicker({
			        timeFormat: 'H:mm p'
			        ,interval:60
		...
		//끝나는 날짜 기준으로 오늘인 경우 현재시간으로부터 4시간 이후로 선택이 가능하고 그 전은 선택이 불가능.
			...
			<tr>
                ...
                <td colspan="3">
					    ...
					    <form method="POST" onsubmit="return false;" enctype="multipart/form-data">
					    	<p style="font-weight: normal;">[ 최소 2장 ~ 최대 5장 ]</p>
					        <input type="file" onchange="addFile(this);" multiple  style="color: red;"/>
