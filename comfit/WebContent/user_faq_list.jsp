...
<br /><br /><br />
	...
	<div class="btns" style="text-align: center;">
		...
		<button type="button" id="faq" class="btn btn-primary" style="margin: 7px;" onclick="location.href='user_faq_list.jsp'">자주묻는질문</button>
	...
	<div style="margin-left: 30%; margin-right: 30%;">
		...
		<br />또한, 도서산간 지역 배송 혹은 천재지변으로 인해 배송일정이 변동될 수 있습니다.
		      </div>
		    </div>
		  </div>
	  <div class="accordion-item">
