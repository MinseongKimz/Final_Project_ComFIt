...
<br /><br /><br />
	<div class="container">
		<span style="font-weight: bold; font-size: 26pt; font: '맑은 고딕'">공지사항</span>
	</div>
	<br />
	<div class="btns" style="text-align: center;">
		<button type="button" class="btn btn-primary" style="margin: 7px;">공지사항</button>
		<button type="button" class="btn btn-secondary" style="margin: 7px;">자주묻는질문</button>
		<button type="button" class="btn btn-secondary" style="margin: 7px;">내 문의내역</button>
	</div>
	<br /><br />
