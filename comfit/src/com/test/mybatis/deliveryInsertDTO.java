...
public class deliveryInsertDTO
{
	...
	private String deli_pd_id, pd_title, pd_name, pd_photo, pd_as_remain, pd_start_price, pd_hitcount
			, pd_regit_date, pd_maker_id, pd_as_id, u_id, cf_price, comments, imd_price;
	...
	public String getPd_start_price()
	{
		return pd_start_price;
	}

	public void setPd_start_price(String pd_start_price)
	{
	...
	public String getImd_price()
	{
		return imd_price;
	}

	public void setImd_price(String imd_price)
	{
